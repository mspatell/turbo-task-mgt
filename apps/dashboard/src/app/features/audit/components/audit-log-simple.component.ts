...
type AuditLogsResponse = PaginatedResponseDto<AuditLogDto>;
  ...
  template: `
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <!-- Empty State -->
        <div *ngIf="!loading && !error && auditData && auditData.data.length === 0" class="text-center py-12">
        ...
        <!-- Audit Log Table -->
        <div *ngIf="!loading && !error && auditData && auditData.data.length > 0" class="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                <tr *ngFor="let log of auditData.data" 
